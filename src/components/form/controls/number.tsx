...
import { number_cell_type } from '../cells/number';

export const NumberControlRenderer = withJsonFormsControlProps((props) => {
...
export const number_control_type = 'number_control_type';

export const numberControlTester = rankWith(1, uiTypeIs(number_control_type));
